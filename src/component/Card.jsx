        ...
        <div className="card bg-base-100 w-96 shadow-xl">
            ...
            <div className="card-body">
                <h2 className="card-title">
                    {pd.productName}
                    <div className="badge badge-secondary">${pd.price}</div>
                </h2>
                <p>{pd.description}</p>
                <div className="card-actions justify-end">
                    <div className="badge badge-outline gap-1"><FcRating />{pd.ratings}</div>
                    <div className="badge badge-outline">{pd.category}</div>
                    <div className="badge badge-outline">{new Date(pd.createdAt).toLocaleDateString()}</div>
                </div>
            </div>
        </div>
...
// pd.productImage,,pd.productName,,,pd.price,,,,pd.ratings,,,pd.category,,,,pd.createdAt  ,,, pd.description ,,,,  ,,